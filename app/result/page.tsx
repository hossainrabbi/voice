...
const MOCK_DATA = [
  {
    ...
    answer: "Next.js is a React framework that provides hybrid static and server rendering, TypeScript support, smart bundling, route pre-fetching, and more. It simplifies building fast, SEO-friendly web applications by providing a convention-based routing system and powerful rendering options out of the box."
  },
  {
    id: 2,
    question: "How does the App Router differ from the Pages Router?",
    answer: "The App Router uses React Server Components by default, allowing for better performance by reducing client-side JavaScript. It also supports nested layouts, simplified data fetching, and improved routing primitives compared to the legacy Pages Router."
  }
];
...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen bg-[#05060a] text-slate-50 p-4 pb-20 md:p-8 flex relative overflow-hidden font-sans">
      ...
      <div className="max-w-3xl mx-auto w-full space-y-8 flex flex-col pt-8 relative z-10 w-full">
        <div className="flex items-center justify-between mb-2">
           <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-light tracking-tight">Voice Interface <span className="text-indigo-400 font-medium italic">Active</span></h1>
           </div>
           <span className="text-[10px] bg-green-500/20 text-green-400 px-3 py-1 rounded border border-green-500/20 uppercase tracking-widest font-bold hidden sm:inline-block">Success</span>
        </div>
            ...
            {transcription.map((item: any, index: number) => (
              ...
              >
                <div className="p-5 md:p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                  <p className="text-indigo-400 text-[10px] font-bold uppercase mb-3 tracking-tighter">Question</p>
